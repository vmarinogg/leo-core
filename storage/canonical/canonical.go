// Package canonical resolves and opens MOM's canonical v0.30 central
// vault and aggregates the full migration set across librarian and
// logbook. Renamed from `centralvault` during the v0.50 reorg.
package canonical
