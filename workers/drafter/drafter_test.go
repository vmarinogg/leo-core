...
func TestExtractFileTags(t *testing.T) {
	paths := []string{
		"workers/drafter/drafter.go",
		"workers/drafter/recorder.go",
	...
	expected := []string{"workers", "drafter", "recorder", "memory"}
...
func TestDetectBoundaries(t *testing.T) {
	turns := []Turn{
		{Text: "working on drafter", FilePaths: []string{"workers/drafter/drafter.go"}, Keywords: []string{"drafter", "pipeline"}},
		{Text: "more drafter work", FilePaths: []string{"workers/drafter/bm25.go"}, Keywords: []string{"bm25", "ranking"}},
