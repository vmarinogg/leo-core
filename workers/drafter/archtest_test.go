...
//   - momhq/mom/bus/herald — the bus it subscribes to.
//   - momhq/mom/storage/librarian — the persistence boundary.
//
...
func TestDrafterImportGraph(t *testing.T) {
	...
	allowedInternal := map[string]bool{
		"github.com/momhq/mom/bus/herald":        true,
		"github.com/momhq/mom/storage/librarian": true,
	}

	for _, imp := range imports {
		if !strings.HasPrefix(imp, "github.com/momhq/mom/") {
